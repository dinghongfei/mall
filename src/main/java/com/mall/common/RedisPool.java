...
public class RedisPool {
    ...
    private static JedisPool pool;//jedisli连接池
    ...
    static {
        ...
        ip = PropertiesUtil.getPropertry("redis.ip");
        port =PropertiesUtil.getIntegerPropertry("redis.port");
        password = PropertiesUtil.getPropertry("redis.password");
